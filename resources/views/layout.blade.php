...
<body class="homepage">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    ...
                    <li>
                      <a href="/register" class="dropdown-item item-anchor">Sign Up </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
          ...
          <ul class="list-unstyled d-flex m-0">
            <li class="d-none d-lg-block">
             @if(Auth::check())
              ...
              @else
               <a href="/register" class="text-uppercase mx-3">Register <span class="wishlist-count"></span>
              </a>
             @endif
            </li>
            <li class="d-none d-lg-block">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img src="users/images/main-logo.png" alt="logo">
              </a>
            </div>
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img src="users/images/arct-icon.png" alt="icon">
              <img src="users/images/dhl-logo.png" alt="icon">
            </div>
            <div class="payment-option">
              <span>Payment Option:</span>
              <img src="users/images/visa-card.png" alt="card">
              <img src="users/images/paypal-card.png" alt="card">
              <img src="users/images/master-card.png" alt="card">
            </div>
          </div>
  ...
  <script src="users/js/SmoothScroll.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
    integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
    crossorigin="anonymous"></script>
  <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
  <script src="users/js/script.min.js"></script>
</body>
